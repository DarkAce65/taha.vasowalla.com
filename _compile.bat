...
ruby %SASS_COMMAND% --style %STYLE% --update global.scss:global.css style.scss:style.css
echo Compiling colors directory...
ruby %SASS_COMMAND% --style %STYLE% --update colors:colors
echo Compiling all subdirectories...
ruby %SASS_COMMAND% --style %STYLE% --update about:about origami:origami photography:photography ventures:ventures school:school tools:tools visual:visual games:games experiments:experiments
